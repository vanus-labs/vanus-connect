...
func init() {
	...
	utilruntime.Must(kedahttp.AddToScheme(scheme))
	utilruntime.Must(cloudvancev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "c5d5ff10.vance.io",
	})
	if err != nil {
	...
	if err = (&controllers.ConnectorReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("connector controller"),
